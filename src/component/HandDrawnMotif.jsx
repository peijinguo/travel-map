...
const motifs = {
  ...
  soba: <><path d="M24 45V20M24 28 13 18M24 33 36 21M24 38 14 31M24 41 34 34"/><path d="M13 18c-5-1-8-5-7-9 6 0 9 4 7 9zM36 21c5-1 8-5 7-9-6 0-9 4-7 9zM14 31c-5-1-8-5-7-9 6 0 9 4 7 9zM34 34c5-1 8-5 7-9-6 0-9 4-7 9z"/><g className="soba-flowers"><path d="m24 8 3 3-3 3-3-3zM17 14l3 3-3 3-3-3zM31 16l3 3-3 3-3-3zM16 26l3 3-3 3-3-3zM32 29l3 3-3 3-3-3z"/></g><path d="M8 45c10-3 22 2 32-1"/></>,
  ...
  strawberry: <><path className="strawberry-fruit" d="M9 18c2-7 9-10 15-8 6-2 13 1 15 8 2 9-8 23-15 27C17 41 7 27 9 18z"/><path className="strawberry-leaves" d="M24 12c-5-7-10-6-13-3 4 1 6 3 7 6M24 12c5-7 10-6 13-3-4 1-6 3-7 6M24 12c-1-6 1-9 4-11 1 5 0 8-4 11z"/><path className="strawberry-seeds" d="M16 21h1m7-3h1m7 3h1M20 27h1m8 0h1M24 34h1M17 32h1m14 0h1"/></>,
